...
{% if site.author.googlescholar %}
  <div class="wordwrap">This page is not updated frequently. Please find my most up-to-date articles on <a href="{{site.author.googlescholar}}">my Google Scholar profile</a>.</div>
{% endif %}
